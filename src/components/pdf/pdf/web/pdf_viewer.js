  ...
  /******/ ([
    ...
    /***/ function (module, exports, __w_pdfjs_require__) {
      ...
      var AnnotationLayerBuilder = /* #__PURE__ */(function () {
        function AnnotationLayerBuilder (_ref) {
          var { pageDiv } = _ref
          var { pdfPage } = _ref
          var { linkService } = _ref
          var { downloadManager } = _ref
          ...
          var renderInteractiveForms = _ref$renderInteractiv === void 0 ? false : _ref$renderInteractiv
    ...
    /***/ function (module, exports, __w_pdfjs_require__) {
      ...
      function waitOnEventOrTimeout (_ref2) {
        ...
        var delay = _ref2$delay === void 0 ? 0 : _ref2$delay
      ...
      var TextLayerBuilder = /* #__PURE__ */(function () {
        ...
        _createClass(TextLayerBuilder, [{
          ...
          value: function _convertMatches (matches, matchesLength) {
            ...
            var { findController } = this
            var { textContentItemsStr } = this
            var i = 0
            var iIndex = 0
          ...
          value: function _renderMatches (matches) {
            ...
            var { highlightAll } = findController.state
            var prevEnd = null
            var infinity = {
              divIdx: -1,
              offset: undefined
    ...
    /***/ function (module, exports, __w_pdfjs_require__) {
      ...
      var DownloadManager = /* #__PURE__ */(function () {
        function DownloadManager (_ref) {
          ...
          var disableCreateObjectURL = _ref$disableCreateObj === void 0 ? DISABLE_CREATE_OBJECT_URL : _ref$disableCreateObj
      ...
      var PDFFindController = /* #__PURE__ */(function () {
        ...
        _createClass(PDFFindController, [{
          ...
          value: function _calculateMatch (pageIndex) {
            ...
            var { caseSensitive } = _this$_state
            var { entireWord } = _this$_state
            var { phraseSearch } = _this$_state
          ...
          value: function _requestMatchesCount () {
            ...
            var { pageIdx } = _this$_selected
            var { matchIdx } = _this$_selected
            var current = 0
    ...
    /***/ function (module, exports, __w_pdfjs_require__) {
        ...
        _createClass(PDFHistory, [{
          ...
          value: function initialize (_ref2) {
            ...
            if (!this._isValidState(state, true) || resetHistory) {
              ...
              var { hash } = _this$_parseCurrentHa
              var { page } = _this$_parseCurrentHa
              var { rotation } = _this$_parseCurrentHa
          ...
          value: function push (_ref3) {
            ...
            var { explicitDest } = _ref3
            var { pageNumber } = _ref3
          ...
          value: function _popState (_ref5) {
            ...
            if (!state) {
              ...
              var { hash } = _this$_parseCurrentHa2
              var { page } = _this$_parseCurrentHa2
              var { rotation } = _this$_parseCurrentHa2
      ...
      function isDestHashesEqual (destHash, pushHash) {
        ...
        var { nameddest } = _parseQueryString
      ...
      var PDFPageView = /* #__PURE__ */(function () {
        ...
        _createClass(PDFPageView, [{
          ...
          value: function cssTransform (target) {
            ...
            var { width } = this.viewport
            var { height } = this.viewport
            var { div } = this
            ...
            if (this.textLayer) {
              ...
              var { textLayerDiv } = this.textLayer
              var transX, transY
        ...
        _createClass(PDFViewer, [{
          ...
          value: function _scrollIntoView (_ref) {
            ...
            if (!pageSpot && !this.isInPresentationMode) {
              ...
              var { scrollLeft } = _this$container
              var { clientWidth } = _this$container
